...
const InstructorList = () => {
    ...
    const fetchInstructors = async () => {
        ...
        console.log('İlk eğitmenin verileri:', res.data.data[0]); 
        console.log('Tüm alanlar:', Object.keys(res.data.data[0] || {})); 
...
const handleDelete = async (id, name, userId) => {
    ...
    console.log('Silinecek ID (userId):', deleteId);
                            ...
                            instructors.map((inst, index) => (
                                <tr key={inst.id} style={{ borderBottom: '1px solid #f0f0f0' }}>
                                    ...
                                    <td style={{ padding: 12, textAlign: 'center' }}>
                                       ...
                                       <button onClick={() => handleDelete(inst.id, `${inst.firstName} ${inst.lastName}`, inst.userId)} style={{
    background: 'none',
    border: 'none',
    color: '#ef4444',
    cursor: 'pointer'
