...
const LessonCreate = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const maxOrder = lessonData.reduce((max, l) => Math.max(max, l.order || 0), 0);
        ...
        <div style={{ maxWidth: 900, margin: '0 auto', padding: '24px 20px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 28 }}>
                ...
                <div>
                    ...
                    <p style={{ color: '#94a3b8', margin: 2, fontSize: 14 }}>Kursa yeni bir ders ekleyin</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} style={{ 
                ...
                <div style={{ marginTop: 16 }}>
                    ...
                    {videoDuration && (
                        <div style={{ marginTop: 4, fontSize: 12, color: '#10b981' }}>
                            ✅ Süre otomatik hesaplandı: <strong>{videoDuration}</strong>
                        </div>
                    )}
                </div>

                {/* 2 Sütun - Önizleme ve diğer */}
                ...
                {/* Resource Bölümü - ORİJİNAL DOSYA ADI GELECEK */}
                <div style={{ 
                    marginTop: 20, 
                    border: '1px solid #e2e8f0', 
                    borderRadius: 12, 
                ...
                {/* Kaynak Dosyası Adı - OTOMATİK DOLAR */}
                <div style={{ marginTop: 16 }}>
                    <label style={{ display: 'block', fontWeight: 600, marginBottom: 6, fontSize: 14, color: '#0f0c29' }}>
                        Kaynak Dosyası Adı
                    </label>
